  ...
  <div className="recipe-form-container">
    ...
    <form onSubmit={handleSubmit} className="recipe-form">
      ...
      <label  className="form-label">
        <img src={timeIcon} alt="Time" className="icon-edit-create" />זמן הכנה:</label>
      <input 
        type="number" 
        name="cooking_time" 
      ...
      {/* Servings section */}
      <label className="form-label">
        <img src={servingsIcon} alt="Servings" className="icon-edit-create" />כמות מנות:</label>
      <input 
        type="number" 
        name="servings" 
      ...
      {/* Categories section */}
      <label className="form-label">
        <img src={categoriesIcon} alt="Categories" className="icon-edit-create" />קטגוריה:</label>
      <input 
        type="text" 
        name="categories" 
      ...
      {/* Tags section */}
      <label className="form-label">
        <img src={tagsIcon} alt="Tags" className="icon-edit-create" />תגית:</label>
      <input 
        type="text" 
        name="tags" 
        value={recipe.tags} 
      ...
      {/* Submit button */}
      <button type="submit" className="btn btn-submit" > עדכן מתכון </button>
    </form>
  </div>
);
}